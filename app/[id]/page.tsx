...
export default function Page() {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center justify-center p-8 bg-zinc-400 dark:bg-zinc-950">
      <div className="flex flex-col items-center justify-center w-full md:w-1/2 lg:w-2/5 lg:max-w-4/5 p-4 rounded-2xl gap-4 bg-zinc-300 dark:bg-zinc-800">
        {reveal && message ? (
          <div className="flex flex-col w-full gap-4 items-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-0 w-full">
              <span
                style={scp.style}
                className="text-xs text-zinc-50 p-4 bg-zinc-700 dark:bg-zinc-900 rounded-lg md:rounded-e-none md:rounded-s-lg w-full md:w-5/6 select-all break-words"
              >
                {message}
              </span>
              <button
                onClick={() => navigator.clipboard.writeText(message)}
                className="flex gap-2 bg-zinc-50 hover:bg-zinc-500 hover:text-zinc-50 active:bg-zinc-400 dark:bg-zinc-600 dark:hover:bg-zinc-500 dark:active:bg-zinc-700 rounded-lg md:rounded-e-lg md:rounded-s-none w-full md:w-1/6 py-2 items-center justify-center"
              >
